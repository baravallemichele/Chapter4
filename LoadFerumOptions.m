...
analysisopt.e1                   = 1e-3;     % Tolerance on how close design point is to limit-state surface
analysisopt.e2                   = 1e-3 ;    % Tolerance on how accurately the gradient points towards the origin
